  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-slate-900">
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute -left-20 top-0 h-72 w-72 rounded-full bg-emerald-400/16 blur-3xl" />
        <div className="absolute right-0 top-32 h-80 w-80 rounded-full bg-teal-300/14 blur-3xl" />
